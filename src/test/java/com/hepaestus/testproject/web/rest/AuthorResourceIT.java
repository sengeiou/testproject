...
class AuthorResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/authors";
     ...
     *
     * @see com.hepaestus.testproject.repository.search.AuthorSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).type(DEFAULT_TYPE);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).type(UPDATED_TYPE);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getType()).isEqualTo(DEFAULT_TYPE);
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).type(UPDATED_TYPE);
        ...
        assertThat(testAuthor.getType()).isEqualTo(UPDATED_TYPE);

        // Validate the Author in Elasticsearch
        verify(mockAuthorSearchRepository).save(testAuthor);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).type(UPDATED_TYPE);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).type(UPDATED_TYPE);
    ...
    void searchAuthor() throws Exception {
        ...
        // Initialize the database
        authorRepository.saveAndFlush(author);
        when(mockAuthorSearchRepository.search(queryStringQuery("id:" + author.getId()))).thenReturn(Collections.singletonList(author));
