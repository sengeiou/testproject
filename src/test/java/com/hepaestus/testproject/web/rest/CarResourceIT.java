...
class CarResourceIT {
    ...
    private static final CustomerType DEFAULT_TYPE = CustomerType.DEFAULT;
    private static final CustomerType UPDATED_TYPE = CustomerType.REGULAR;
     ...
     *
     * @see com.hepaestus.testproject.repository.search.CarSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Car createEntity(EntityManager em) {
        Car car = new Car().name(DEFAULT_NAME).title(DEFAULT_TITLE).date(DEFAULT_DATE).type(DEFAULT_TYPE);
        return car;
    }
    ...
    public static Car createUpdatedEntity(EntityManager em) {
        Car car = new Car().name(UPDATED_NAME).title(UPDATED_TITLE).date(UPDATED_DATE).type(UPDATED_TYPE);
        return car;
    }
    ...
    void createCar() throws Exception {
        ...
        assertThat(testCar.getTitle()).isEqualTo(DEFAULT_TITLE);
        assertThat(testCar.getDate()).isEqualTo(DEFAULT_DATE);
    ...
    void putNewCar() throws Exception {
        ...
        updatedCar.name(UPDATED_NAME).title(UPDATED_TITLE).date(UPDATED_DATE).type(UPDATED_TYPE);
        ...
        assertThat(testCar.getTitle()).isEqualTo(UPDATED_TITLE);
        assertThat(testCar.getDate()).isEqualTo(UPDATED_DATE);
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.name(UPDATED_NAME).title(UPDATED_TITLE).date(UPDATED_DATE);
    ...
    void fullUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.name(UPDATED_NAME).title(UPDATED_TITLE).date(UPDATED_DATE).type(UPDATED_TYPE);
