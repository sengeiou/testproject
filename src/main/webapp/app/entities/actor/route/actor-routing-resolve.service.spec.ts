...
describe('Service Tests', () => {
  describe('Actor routing resolve service', () => {
    ...
    let routingResolveService: ActorRoutingResolveService;
    let service: ActorService;
    let resultActor: IActor | undefined;
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(ActorRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new IActor if id is not provided', () => {
        ...
        expect(resultActor).toEqual(new Actor());
      });
